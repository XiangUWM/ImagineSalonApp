			...
			<div id="add_appointment" class="add_appointment">
				<div id="popupAppointment" class="popupAppointment">
					<form id="appointment_form" class="appointment_form" method="post" name="form" action="process.php">
						...
						<br>
						<?php
							$db_cal_path = '../../../../config/db/db.php';
							if(file_exists($db_cal_path)) {
								require($db_cal_path);
								echo '<script>console.log("database for calendar connected");</script>';
							} else {
								echo '<script>console.log("database for calendar is not connected in the model");</script>';
							}
						...
						<br>
						<link rel="stylesheet" type="text/css" href="app/model/timepicker/jquery.timepicker.css" />
						<link rel="stylesheet" type="text/css" href="app/model/timepicker/lib/bootstrap-datepicker.css" />
						<script type="text/javascript" src="app/model/timepicker/lib/bootstrap-datepicker.js"></script>
						<script type="text/javascript" src="app/model/timepicker/jquery.timepicker.js"></script>
						<script type="text/javascript" src="app/model/datepair/dist/datepair.js"></script>
						<script>
